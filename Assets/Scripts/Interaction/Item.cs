...
public abstract class Item : Interactable
{
    ...
    [SerializeField] private InteractableWithItem.ItemType itemName = InteractableWithItem.ItemType.None;
    public string ItemName {get {return itemName.ToString().Replace('_',' ');}}
    public InteractableWithItem.ItemType it {get => itemName;}
    ...
    {
        if(itemName == InteractableWithItem.ItemType.None) Debug.LogWarning($"Item {gameObject} has no name.");
